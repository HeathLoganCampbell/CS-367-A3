...
expand_OpenNode(OpenNode, Actions, SuccessorNodes) :-
   ...
   %  ParentGValue is ParentGValue + HValue,
   %  writeln('=== Help derp Expanding Node'),
   %  writeln(OpenNode),
   %  writeln('^^^^ STATE node'),
   %  writeln(Actions),
   %  writeln('^^^^ Actions node'),
    ...
    findall(ChildNode,
        ...
        h(ChildState, Actions, HValue),
	     ChildGValue is ParentGValue + ChildCost + HValue,
        write('Node = '),
        writeln(ChildState),
        writeln(ParentGValue),
        write('g = '),
        writeln(ChildCost),
        write('h = '),
        writeln(HValue),
